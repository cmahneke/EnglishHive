var perduNiveau2 = (function () {
	var _jeu;
	var perduNiveau2 = function (jeu) {
		_jeu = jeu;
	}

	perduNiveau2.prototype = {
		create: function () {
            _jeu.stage.backgroundColor = '#77e4fe'; 
            _jeu.ecran_perduNiveau2 = _jeu.add.sprite(160, -40, "perdant");
            _jeu.ecran_perduNiveau2.scale = new Phaser.Point(.8,.8);
            
            _jeu.bouton = _jeu.add.button(_jeu.world.centerX, _jeu.world.centerY, "boutonPlayAgain", this.redemarrerNiveau2, this);
        ...
        redemarrerNiveau2 : function(){
            //console.log("Jouer...");
            _jeu.state.start("Niveau2");
        },
