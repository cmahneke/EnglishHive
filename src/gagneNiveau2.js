var gagneNiveau2 = (function () {
	var _jeu;
	var gagneNiveau2 = function (jeu) {
		_jeu = jeu;
	}

	gagneNiveau2.prototype = {
		create: function () {
            _jeu.stage.backgroundColor = '#77e4fe'; 
            _jeu.ecran_gagneNiveau2 = _jeu.add.sprite(160, -40, "gagnant");
            _jeu.ecran_gagneNiveau2.scale = new Phaser.Point(.8,.8);
            
            _jeu.bouton = _jeu.add.button(_jeu.world.centerX, _jeu.world.centerY, "boutonPlayAgain", this.demarrerNiveau1, this);
