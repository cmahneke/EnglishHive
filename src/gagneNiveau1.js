var gagneNiveau1 = (function () {
	var _jeu;
	var gagneNiveau1 = function (jeu) {
		_jeu = jeu;
	}

	gagneNiveau1.prototype = {
		create: function () {
            _jeu.stage.backgroundColor = '#77e4fe'; 
            _jeu.ecran_gagneNiveau1 = _jeu.add.sprite(160, -40, "finNiveau1");
            _jeu.ecran_gagneNiveau1.scale = new Phaser.Point(.8,.8);
            
            _jeu.bouton = _jeu.add.button(_jeu.world.centerX, _jeu.world.centerY, "boutonContinue", this.demarrerNiveau2, this);
            _jeu.bouton.anchor.setTo(0.55,.3);
            _jeu.tunnels.destroy(true, false);
